    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="flex min-h-[70vh] flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-[var(--accent)]">Pharmaceutical Machinery</p>
          <h1 className="mb-6 text-5xl font-black uppercase tracking-[0.08em] text-slate-900 sm:text-6xl lg:text-7xl">
            COMING SOON
          </h1>
          <p className="mt-4 text-lg text-slate-600 sm:text-xl">
            Our Pharmaceutical Machinery section is under construction.
          </p>
          <div className="mt-8">
            <Link
              href="/contact"
