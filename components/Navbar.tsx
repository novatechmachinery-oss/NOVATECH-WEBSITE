...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto hidden max-w-[1460px] items-center justify-center px-4 py-0.5 xl:flex xl:px-6">
            ...
            {navItems.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`group relative whitespace-nowrap rounded-full px-4 py-1.5 transition-all duration-300 ${
                    isActive
